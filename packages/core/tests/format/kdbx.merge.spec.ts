...
import * as kdbxweb from '../../src/index';
...
describe('Kdbx.merge', () => {
    ...
    const bin = {
        bin1: kdbxweb.ByteUtils.arrayToBuffer(kdbxweb.ByteUtils.stringToBytes('bin1')),
        bin2: kdbxweb.ByteUtils.arrayToBuffer(kdbxweb.ByteUtils.stringToBytes('bin2')),
        bin3: kdbxweb.ByteUtils.arrayToBuffer(kdbxweb.ByteUtils.stringToBytes('bin3')),
        bin4: kdbxweb.ByteUtils.arrayToBuffer(kdbxweb.ByteUtils.stringToBytes('bin4')),
        icon1: kdbxweb.ByteUtils.arrayToBuffer(kdbxweb.ByteUtils.stringToBytes('icon1')),
        icon2: kdbxweb.ByteUtils.arrayToBuffer(kdbxweb.ByteUtils.stringToBytes('icon2'))
    };
